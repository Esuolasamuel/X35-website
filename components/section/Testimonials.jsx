    ...
    return (
        <section className=" p-7.5 sm:p-15 md:p-20 lg:p-25 xl:p-30 2xl:p-30 mx-auto bg-white">
                <div className="mx-auto">
                    <h2 className=" text-2xl md:text-4xl lg:text-[55px] font-heading font-bold text-dark-500 text-center mb-12">What Our Clients Say</h2>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8 2xl:gap-9">
                        {testimonials.map((t, i) => (
                            <div key={i} className=" p-2 sm:p-4 md:p-8 xl:p-10 rounded-lg sm:rounded-lg w-97.5 h-52 md:rounded-xl lg:rounded-2xl md:bg-white md:shadow-[0px_16px_32px_0px_#BDBDBD40] border border-[#0C0C1C0F]">
                                <p className=" text-xs md:text-sm lg:text-base font-medium font-body mb-4 text-dark-500">“{t.text}”</p>
                                <span className="text-xs md:text-xs lg:text-sm flex justify-center items-center font-medium font-body pt-4 text-dark-500 ">
                                    <div className="pr-3">
                                        <Image
                                        src={t.img}
                                        alt={t.author}
