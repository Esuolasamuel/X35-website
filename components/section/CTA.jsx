...
export default function CTA({title, text, paragraph, id}) {
    ...
    return (
        <section id={`${id ? id : ''}`} className="relative bg-[url(@/assets/images/image-9.png)] w-full min-h-135.75 z-50">
            <div className="absolute inset-0 bg-[#C9C9DC] z-20 opacity-50"></div>
            <div className="relative md:px-6 text-center h-full">
