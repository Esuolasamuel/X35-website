...
export default function CTA({title, text, paragraph, id}) {
    ...
    return (
        <section id={`${id ? id : ''}`} className ="p-3.5 sm:p-7.5 md:p-15 lg:p-30 bg-[url(@/assets/images/image-9.png)] bg-[#C9C9DC] z-auto">
            <div className="max-w-5xl md:px-6 text-center">
                ...
                className="bg-yellow-400 hover:bg-[#FFD700] px-6 sm:px-7 md:px-8 py-2 sm:py-3 rounded-full font-body cursor-pointer font-medium">{text} </button>}
                    {paragraph && <p
