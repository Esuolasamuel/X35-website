export default function CTA({title, text, paragraph, id}) {
    return (
        <section id={`${id ? id : ''}`} className="xl:p-24 lg:p-24 md:p-16 py-4 bg-[url(@/public/images/image-9.svg)] bg-[#C9C9DC] z-auto">
            <div className="max-w-5xl mx-auto px-4 md:px-6 text-center">
                ...
                {text && <button className="bg-yellow-400 px-6 sm:px-7 md:px-8 py-2 sm:py-3 rounded-full font-body font-medium">{text}</button>}
                {paragraph && <p
