    ...
    return (
        <section className="bg-white">
            <div className="p-6 sm:p-7.5 md:p-15 lg:p-25 mx-auto">
                <div className="w-full max-w-380 h-auto flex flex-col lg:flex-row items-center gap-5 sm:gap-5 md:gap-10 xl:gap-20 justify-center mx-auto">
                    <div className="w-full lg:w-2/5 xl:w-113.25 text-[#0C0C1C]">
                        <h2 className="text-4xl md:text-5xl font-bold text-center lg:text-start font-heading text-[#0C0C1C]">Who we are</h2>
                    </div>
                    <div className="lg:flex-1 lg:min-w-0 max-w-xl space-y-8 lg:space-y-10 text-base lg:text-lg text-[#0C0C1C] font-body font-normal leading-relaxed tracking-[-0.03em] text-start">
