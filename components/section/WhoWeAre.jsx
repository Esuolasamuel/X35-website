        ...
        <section className="bg-white">
            <Container>
                <div className="w-full max-w-380 h-auto flex flex-col lg:flex-row gap-10 lg:gap-20 mx-auto">
                    ...
                    <div className="w-full lg:w-1/2 space-y-7 lg:space-y-10 text-base lg:text-lg text-dark-500 font-body font-normal leading-relaxed tracking-[-0.03em] text-start">
