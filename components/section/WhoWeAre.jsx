...
export default function WhoWeAre() {
    return (
        <section className="bg-white">
            <Container>
                <div className="grid md:grid-cols-2 gap-20 w-[1440px] h-[612px] p-[120px]">
                    <div className="w-full h-full flex items-center justify-center">
                        <h2 className="text-5xl font-bold text-center font-heading">Who we are</h2>
                    </div>
                    <div className="space-y-6 text-dark-500 font-body font-normal leading-relaxed tracking-[-0.03em] text-center">
