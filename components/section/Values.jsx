...
export default function Values({ values }) {
  return (
    <section className="bg-white">
      <Container>
        <h2 className="text-center text-lg sm:text-xl md:text-3xl lg:text-5xl font-bold font-heading text-dark-500 mb-12">Our Values</h2>
        <div className="grid md:grid-cols-3 gap-6">
          {values.map((v) => (
            /* Added 'group' class to the card container */
            <div
              key={v.title}
              className="group bg-yellow-600 font-body font-normal text-dark-500 rounded-xl py-6.5 md:py-12 px-6 md:px-10 transition-all duration-500 hover:shadow-lg"
            >
