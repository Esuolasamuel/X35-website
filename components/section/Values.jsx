      ...
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {values.map((v) => (
            ...
            <div
              key={v.title}
              className="group bg-yellow-600 font-body h-96 w-61.5 font-normal text-dark-500 rounded-xl py-6.5 md:py-13 px-6 md:px-10 transition-all duration-500 hover:shadow-lg"
            >
