...
export default function VisionMission() {
    return (
        <section className=" bg-white text-white">
            <Container>
                <div className=" flex flex-col lg:flex-row gap-4 sm:gap-4 md:gap-4 lg:gap-6 xl:gap-6 2xl:gap-6">
                    <div className="p-4 sm:p-4 md:p-5 lg:p-6 xl:p-6 2xl:p-6 sm:max-w-55 md:max-w-80 lg:max-w-110 sm:lg-10 md:lg-15 lg:h-25 rounded-xl bg-indigo-600">
                    ...
                    <div className="p-4 sm:p-4 md:p-5 lg:p-6 xl:p-6 2xl:p-6 sm:max-w-55 md:max-w-80 lg:max-w-110 sm:lg-10 md:lg-15 lg:h-25 lg:w-110 rounded-xl bg-indigo-600">
