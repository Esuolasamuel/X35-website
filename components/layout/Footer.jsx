        ...
        <>
            <footer className="bg-indigo-700 pt-8 px-15 sm:px-20 md:px-25 lg:px-30 xl:px-30 2xl:px-30 lg:pt-12 xl:pt-16 xxl:pt-20 xxxl:pt-24 border-t mx-auto">
                <div className="flex flex-col items-start justify-center gap-3 xs:gap-4 sm:gap-4 md:gap-4 lg:gap-5 xl:gap-5 xxl:gap-6 xxxl:gap-6 border-b-[0.5px] border-white/40 pb-8 xs:pb-9 sm:pb-10 md:pb-11 lg:pb-12 xl:pb-13 xxl:pb-14 xxxl:pb-15 text-center mx-auto">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <h4 className="text-white/60 text-xs xs:text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm xxl:text-sm xxxl:text-sm font-body text-dark font-semibold mb-4 xs:mb-5 sm:mb-6 md:mb-7">Contact Us</h4>
                        <a href="mailto:hello@xsprojects.com" className="text-xs xs:text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm xxl:text-sm xxxl:text-sm font-body text-white pb-4 xs:pb-5 sm:pb-6 block hover:text-yellow-700 transition-colors md:font-body md:font-medium md:leading-[31.2px] md:tracking-normal md:[leading-trim:CAP_HEIGHT]">
                            hello@xsprojects.com
                        </a>
                        <a href="tel:+2348144694380" className="text-xs xs:text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm xxl:text-sm xxxl:text-sm text-white font-body hover:text-yellow-700 transition-colors md:font-body md:font-medium md:leading-[31.2px] md:tracking-normal md:[leading-trim:CAP_HEIGHT]">
                            +234 814 469 4380
                        </a>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        <h4 className="text-white/60 text-xs xs:text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm xxl:text-sm xxxl:text-sm font-body text-dark font-semibold mb-4 xs:mb-5 sm:mb-6 md:mb-7">Follow Us</h4>
                        <div className="text-xs xs:text-sm sm:text-sm md:text-smg lg:text-sm xl:text-sm xxl:text-sm xxxl:text-sm gap-4 xs:gap-5 sm:gap-6 ">
